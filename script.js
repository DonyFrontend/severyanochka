...
const PRODUCTS = [
  { id: 1, name: 'Комбайн КЗС-1218 «ДЕСНА-ПОЛЕСЬЕ GS12»', price: 139.99, oldPrice: null, badge: null, note: null, rating: 2, image: IMAGES.combine },
  { id: 2, name: 'Молоко ПРОСТОКВАШИНО паст. питьевое цельное отборное...', price: 69.99, oldPrice: 140.50, badge: '-50%', note: 'С картой', rating: 3, image: IMAGES.milk, inCart: true },
  { id: 3, name: 'Молоко сгущенное РОГАЧЕВ Егорка, цельное с сахаром...', price: 77.99, oldPrice: 168.50, badge: '-50%', note: 'С картой', rating: 4, image: IMAGES.condensed },
  { id: 4, name: 'Молоко сгущенное РОГАЧЕВ Егорка, цельное с сахаром...', price: 77.99, oldPrice: 168.50, badge: '-50%', note: 'Обычная', rating: 4, image: IMAGES.condensed },
  { id: 5, name: 'Масло сливочное Крестьянское 73%', price: 192.99, oldPrice: null, badge: null, note: null, rating: 3, image: IMAGES.butter },
  { id: 6, name: 'Йогурт Фруттис клубника-банан 4х115г', price: 29.99, oldPrice: null, badge: null, note: null, rating: 3, image: IMAGES.yogurt },
  { id: 7, name: 'Йогурт Фруттис малина-черника 4х115г', price: 29.99, oldPrice: null, badge: null, note: null, rating: 2, image: IMAGES.yogurt },
  { id: 8, name: 'Йогурт Фруттис персик-маракуйя 4х115г', price: 29.99, oldPrice: null, badge: null, note: null, rating: 3, image: IMAGES.yogurt },
];
...
// ---------- Filters ----------
document.getElementById('priceChip').querySelector('[data-remove="price"]').addEventListener('click', () => {
...
document.getElementById('pagination').addEventListener('click', e => {
  ...
  document.querySelectorAll('.page-btn--num').forEach(b => b.classList.remove('is-active'));
